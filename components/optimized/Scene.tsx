  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const updateScene = (progress: number) => {
        ...
        setSaintScale(
          mapRangeClamped(progress, saintRangeStart, saintRangeEnd, 0.8, isDesktop ? 1.7 : 1.1)
        );
        ...
        >
          <div className="sticky top-0 h-screen overflow-hidden" style={{ height: pinnedHeight }}>
            ...
            <div
              ...
              style={{ willChange: "transform, opacity" , top : fixedViewportHeight / viewportWidthRef.current < 16/9*1.1 ? -540 : -400}}
            >
