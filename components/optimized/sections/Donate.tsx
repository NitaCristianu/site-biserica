      ...
      >
        ...
        >
          <Image
            ...
            priority
            quality={100}
            className="object-cover object-bottom md:hidden z-3 relative bg-red-500"
            alt="background"
          />

         

          <div className="text-shadow-black/10 text-shadow-lg pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-4 px-6 text-center text-white">
            <motion.h2
            ...
            <motion.p
              ...
              className=" max-w-[60vw] text-base text-white/80 sm:text-lg "
            >
              <span
                className="text-shadow-black/40 shadow-lg"
              >
